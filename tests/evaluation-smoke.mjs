...
assert.equal(report.feedback.concepts.diagnostics.acceptedMissed.length, 1, "evaluation diagnostics should identify missed accepted concepts");
assert.equal(report.feedback.concepts.diagnostics.rejectedPresent.length, 1, "evaluation diagnostics should identify surviving rejected concepts");
assert.equal(report.feedback.concepts.diagnostics.acceptedMatched.length, 1, "evaluation diagnostics should identify matched accepted concepts");
assert.equal(report.feedback.concepts.diagnostics.rejectedSuppressed.length, 0, "evaluation diagnostics should identify suppressed rejected concepts");
