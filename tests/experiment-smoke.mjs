...
assert.equal(learningLoop.proof.acceptedRelationRetained, true, "the learning loop should retain an accepted relation in follow-up extraction");
assert.equal(learningLoop.proof.rejectedRelationSuppressed, true, "the learning loop should suppress a rejected relation in follow-up extraction");
...
assert.equal(learningLoop.stages.comparison.rejectedRelationPresentWithoutGuidance, true, "the relation baseline should contain the rejected relation");
assert.equal(learningLoop.stages.comparison.rejectedRelationPresentWithGuidance, false, "the guided relation follow-up should suppress the rejected relation");
